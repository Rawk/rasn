...
## [0.26.2](https://github.com/Rawk/rasn/compare/rasn-v0.26.1...rasn-v0.26.2) - 2025-04-11

### Added

- inner subtype constraint ([#437](https://github.com/Rawk/rasn/pull/437))
...
- remove SetOf hashbrown dependency ([#438](https://github.com/Rawk/rasn/pull/438))

### Other

- Replace CI scripts with justfile which can be used locally as well ([#441](https://github.com/Rawk/rasn/pull/441))
